...
""",
    ...
    },
    {
        ...
        "deck_group": "Field Rep Journeys",
        "inventory_status": "✅ up-to-date",
        "inventory_note": "Refreshed screenshots and notes for the current share form, doctor list statuses, and chatbot-enabled public rep pages.",
        "document_purpose": "Document the day-to-day field-rep workflow for choosing doctors, selecting collateral, sharing through WhatsApp, and bulk-uploading doctor rosters.",
        ...
        "steps": [
            ...
            {
                "number": 2,
                "title": "Select or confirm the doctor context",
                "user_does": "Choose a doctor from the assigned doctor list or type a doctor name and WhatsApp number manually into the share form.",
                "user_sees": "Manual input controls on the left and a searchable doctor list on the right, including Sent, Reminder Due, and Opened-style status cues.",
                "why_it_matters": "Doctor identification drives the later verification step, so the number needs to be accurate.",
                "expected_result": "The rep is ready to pair the right doctor with the right collateral.",
                "trainer_notes": "Emphasize that the same WhatsApp number will be required again by the doctor to unlock the content.",
                "screenshot_file": "fieldrep-doctor-status.png",
                "screenshot_caption": "Share page section showing the assigned doctor list and send-status controls.",
                "screenshot_focus": "The searchable doctor roster and status-aware action buttons available during sharing.",
            },
            {
                "number": 3,
                "title": "Choose collateral and launch the WhatsApp handoff",
                "user_does": "Select the collateral, submit the share form or doctor-row action, and allow the browser to open the WhatsApp deep link generated for that doctor and campaign.",
                "user_sees": "A campaign-specific share action that uses the stored message template and short link, then hands the session off to WhatsApp.",
                "why_it_matters": "This is the main product outcome for the field rep: a doctor receives a trackable, campaign-linked message.",
                "expected_result": "A ShareLog is created and the doctor receives a WhatsApp message containing the short link.",
                "trainer_notes": "During live training, you can stop after the generated message step if opening WhatsApp is not appropriate for the session.",
                "screenshot_file": "fieldrep-gmail-share.png",
                "screenshot_caption": "Share screen immediately before launching the WhatsApp handoff.",
                "screenshot_focus": "The campaign-collateral selection and action button used to send the message.",
            },
            {
                "number": 4,
