...
<body>
    <div class="container mt-5">
        <div class="btn-container">
            ...
            <a href="https://<?php echo $reports; ?>.<?php echo $cpd; ?>/reports/collateral_report_portal/MHlvVeLT/collateral_details.php?brand_campaign_id=<?php echo urlencode($brand_campaign_id); ?>" class="btn btn-light">Collateral Details</a>
            <a href="https://<?php echo $reports; ?>.<?php echo $cpd; ?>/reports/collateral_report_portal/MHlvVeLT/index1.php?brand_campaign_id=<?php echo urlencode($brand_campaign_id); ?>" class="btn btn-danger">Report 2</a>
                ...
                <?php if (!empty($field_reps_data)): ?>
                    <?php foreach ($field_reps_data as $rep): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($rep['region']); ?></td>
                        </tr>
                    <?php endforeach; ?>
                    <!-- Total row -->
                    <tr>
