...
<div class="container mt-5">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            <?php
            $collaterals = [
                246 => "Mini CME on Complications Associated with Typhoid Fever in Pediatric Patients: Identification and Management",
                257 => "Antibiotic Resistance in Typhoid Fever: Current Trends and Treatment Modalities - Video",
                256 => "Antibiotic Resistance in Typhoid Fever: Current Trends and Treatment Modalities - PDF",
                363 => "Mini CME on Comparative Analysis of Antibiotic Treatments for Pediatric UTIs.",
                376 => "MINI CME - Managing Drug-Resistant Infections in Pediatrics_ Strategies for using cefixime, cephalosporins, and carbapenems in complex cases"
            ];
