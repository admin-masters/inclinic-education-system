...
<div class="container mt-5">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            <?php
            $collaterals = [
                360 => "Mini CME on Iron Deficiency Anemia in Pediatrics: Diagnosis and Management",
                401 => "MC Advanced Management of Iron Deficiency Anemia in Special Populations"
            ];
