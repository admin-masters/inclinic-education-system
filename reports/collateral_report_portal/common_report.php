...
<div class="container mt-5">
    <div class="btn-container">
        ...
        <a href="https://<?php echo $reports; ?>.<?php echo $cpd; ?>/reports/collateral_report_portal/download_csv.php?brand_campaign_id=<?php echo urlencode($brand_campaign_id); ?>" class="btn btn-success">Download CSV</a>
        <a href="https://<?php echo $reports; ?>.<?php echo $cpd; ?>/reports/collateral_report_portal/date_report.php?brand_campaign_id=<?php echo urlencode($brand_campaign_id); ?>" class="btn btn-warning">Custom Report</a>
    </div>
