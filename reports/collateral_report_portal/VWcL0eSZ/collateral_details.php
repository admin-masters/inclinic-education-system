...
<div class="container mt-5">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            <?php
            $collaterals = [
                301 => "Mini CME: Influenza (Flu) in Children",
                322 => "Mini CME on Pediatricians as Key Advocates: Ensuring Family Vaccinations for All in India",
                345 => "MINI - CME MMR Vaccination: Dispelling Myths and Optimizing Uptake",
                358 => "Mini CME- Rabies: Understanding and Prevention with Monoclonal Antibodies"
            ];
