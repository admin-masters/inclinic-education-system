...
<div class="container mt-5">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            <?php
            $collaterals = [
                323 => "Mini CME on Emerging trends in respiratory infections beyond the common viruses, such as RSV and influenza",
                382 => "Mini CME on Management of Upper Respiratory Tract Infections in Children",
                395 => "Mini CME on Advancements in Rapid Diagnostic Testing for Pediatric Infections",
                396 => "Mini CME on High Dose Amoxicillin Clavulanic Acid: Indications, Safety, and Efficacy",
                412 => "Mini CME on Antibiotics in the Management of Otitis Media in Children"
            ];
