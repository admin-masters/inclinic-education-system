...
<body>
    <div class="container mt-5">
        <div class="btn-container">
            ...
            <a href="https://<?php echo $reports; ?>.<?php echo $cpd; ?>/reports/Zuventus/common_report.php?brand_campaign_id=<?php echo urlencode($brand_campaign_id); ?>" class="btn btn-warning">Cumulative</a>
            <a href="index1.php?brand_campaign_id=<?php echo urlencode($brand_campaign_id); ?>" class="btn btn-danger">Report 2</a>
            <a href="https://<?php echo $reports; ?>.<?php echo $cpd; ?>/reports/Zuventus/rJE1bRs8/collateral_details.php?brand_campaign_id=<?php echo urlencode($brand_campaign_id); ?>" class="btn btn-light">Collateral Details</a>
        </div>
