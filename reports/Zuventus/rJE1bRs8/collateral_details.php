...
<div class="container mt-5">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            <?php
            $collaterals = [
                380 => "Mini CME on Utilizing Growth Charts in Pediatric Practice",
                381 => "Mini CME on Iron Deficiency Anemia in Pediatrics: Diagnosis and Management",
                457 => "Mini CME on Trace Elements in Pediatric Health: Focus on Early Development"
            ];
