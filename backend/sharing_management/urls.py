...
urlpatterns = [
    ...
    path('prefilled-fieldrep-gmail-share-collateral/', views.prefilled_fieldrep_gmail_share_collateral, name='prefilled_fieldrep_gmail_share_collateral'),
    ...
    path('fieldrep-whatsapp-share-collateral/', views.fieldrep_whatsapp_share_collateral, name='fieldrep_whatsapp_share_collateral'),
